...
import { gt } from '../assets';

export default function Footer() {
    return (
        // <div>hi</div>
        <footer>
            <div class="bg-violent-900 py-4 text-blue-700">
                <div class="container px-4 mx-auto">
                    <div class="-mx-4 flex flex-wrap justify-between">
                        <div class="px-4 my-4 w-full xl:w-1/5">
                            <a href="/" class="block w-48">
                                <img src={`${gt}`} alt="" srcset="" />
                            </a>
                            <p class="ml-10 text-left">
                                The MS Project is a prominent and one of the oldest Website Design and Development Company in Anand Vidhyanagar. In addition to that to help big brands to optimize their marketing cost we help them with Professional SEO.
                            </p>
                        </div>
                        ...
                        <div class="px-4 my-4 w-full sm:w-auto">
                            ...
                            <ul class="leading-8">
                                ...
                                <li><a href="#portfolio" class="hover:text-blue-400">Our Work</a></li>
                                <li><a href="#clients" class="hover:text-blue-400">Clients</a></li>
                            </ul>
                        </div>
                        <div class="px-4 my-4 w-full sm:w-auto">
                            <div>
                                <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Support</h2>
                            </div>
                            <ul class="leading-8">
                                <li><a href="#" class="hover:text-blue-400">Help Center</a></li>
                                <li><a href="#" class="hover:text-blue-400">Contact Us</a></li>
                                <li><a href="#" class="hover:text-blue-400">Book Now</a></li>
                ...
                <div class="container mx-auto px-4">
                    <div class="-mx-4 flex flex-wrap justify-between">
                        <div class="px-4 w-full text-center sm:w-auto sm:text-left">
                            Copyright © 2020
                            {/* {{ new Date().getFullYear() > 2020 && document.write("- " + new Date().getFullYear()) }}- 2022 */}
