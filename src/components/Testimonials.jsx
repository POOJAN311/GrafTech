...
export default function Testimonials() {
    return (
        <section id="testimonials" aria-label="What our customers are saying" className="sm:py-16">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-2xl md:text-center">
                    <h2 className="font-display font-semibold text-5xl tracking-tight uppercase text-blue-500 sm:text-4xl">testimonials</h2>
                    <h2 className="font-display font-normal mt-3 text-2xl tracking-tight text-gray-500 sm:text-4xl">What Our Customers Are Saying</h2>
                    <p className='text-gray-400'>We place huge value on strong relationships and have seen the benefit they bring to our buisness. Customer feedback is vital in helping us to get it right.</p>
                </div>
                <ul role="list"
                                ...
                                <figure className="relative rounded-2xl bg-gray-400 p-6 shadow-xl shadow-slate-900/10"><svg aria-hidden="true"
                                    ...
                                    <blockquote className="relative">
                                        <p className="text-lg tracking-tight text-slate-900">I love the fitness apparel and gear I purchased from
                                            this site. The quality is exceptional and the prices are unbeatable and affordable.</p>
                                    </blockquote>
